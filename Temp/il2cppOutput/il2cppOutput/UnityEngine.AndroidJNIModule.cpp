...
IL_0047:
	...
	{// begin try (depth: 1)
		...
		}
		{
			...
			L_25 = VirtualFuncInvoker1< MethodInfoU5BU5D_tDF3670604A0AECF814A0B0BA09B91FBF0D6A3265*, int32_t >::Invoke(99 /* System.Reflection.MethodInfo[] System.Type::GetMethods(System.Reflection.BindingFlags) */, L_23, L_24);
			V_12 = L_25;
			V_13 = 0;
...
IL_021b:
	{
		...
		NullCheck(L_78);
		bool L_81;
		L_81 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(126 /* System.Boolean System.Type::Equals(System.Type) */, L_78, L_80);
		V_17 = L_81;
		bool L_82 = V_17;
		if (!L_82)
		{
...
IL_023d:
	{
		...
		NullCheck(L_83);
		bool L_86;
		L_86 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(126 /* System.Boolean System.Type::Equals(System.Type) */, L_83, L_85);
		V_18 = L_86;
		bool L_87 = V_18;
		if (!L_87)
		{
...
IL_025f:
	{
		...
		NullCheck(L_88);
		bool L_91;
		L_91 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(126 /* System.Boolean System.Type::Equals(System.Type) */, L_88, L_90);
		V_19 = L_91;
		bool L_92 = V_19;
		if (!L_92)
		{
